...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Dash()
    {
        rb.linearVelocity = charSprite.flipX ? new Vector2(-1f * dashSpeed, rb.linearVelocity.y) : new Vector2(1f * dashSpeed, rb.linearVelocity.y);
    }
    ...
    private void WallJump()
    {
        ...
        rb.linearVelocity = charSprite.flipX ? new Vector2(wallJumpForce.x, wallJumpForce.y) : new Vector2(-wallJumpForce.x, wallJumpForce.y);
